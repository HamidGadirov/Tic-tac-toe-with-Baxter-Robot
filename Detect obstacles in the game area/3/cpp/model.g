...
#frame volumeL { shape:ssBox size:[.4 .4 .5 .01] color:[.5 0 0 .2] X:<t(-.2 .7 1.1) d(20 1 0 0)>, noVisual }
#frame volumeR { shape:ssBox size:[.4 .4 .5 .01] color:[.5 0 0 .2] X:<t( .2 .7 1.1) d(20 1 0 0)>, noVisual }
